        ...
        columnDefs: [
            {
                ...
                render: function (data, type, row) {
                   var editar ='<a type="button" class="btn btn-outline-success btn-sm btn-round" data-toggle="tooltip" title="Editar Datos" href="/area/editar/'+data+'"><i class="fa fa-edit"></i></a> ';
